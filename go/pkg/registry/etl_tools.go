...
func (r *UnifiedRegistry) PopulateETLTools() {
	...
	extractRef := base + "/tucker.mcproto.analytics.v1.ExtractRequest:main"
	transformRef := base + "/tucker.mcproto.analytics.v1.TransformRequest:main"
	loadRef := base + "/tucker.mcproto.analytics.v1.LoadRequest:main"
